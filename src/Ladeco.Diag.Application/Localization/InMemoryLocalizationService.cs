...
public sealed class InMemoryLocalizationService : ILocalizationService
{
    ...
    public static InMemoryLocalizationService DutchDefaults() => new(
        new Dictionary<string, string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            ["Dialog.Yes"] = "Ja",
            ["Dialog.No"] = "Nee",
            ["Account.CreateTitle"] = "Administratoraccount maken",
            ["Account.CreateButton"] = "Administrator maken",
            ["Account.UserName"] = "Gebruikersnaam",
            ["Account.UserNamePlaceholder"] = "Nieuwe lokale gebruiker",
            ["Account.Password"] = "Wachtwoord",
            ["Account.PasswordConfirmation"] = "Wachtwoord bevestigen",
            ["Account.Create"] = "Aanmaken",
            ["Account.Failed"] = "Account aanmaken mislukt",
            ["Account.Created"] = "Account aangemaakt",
            ["Account.LogoffPrompt"] = "Het administratoraccount is aangemaakt. Nu afmelden zodat u ermee kunt inloggen?",
            ...
            ["Action.WorkOrSchoolSettings"] = "Windows opent nu Toegang tot werk of school. U kunt daar een Active Directory- of Entra ID-organisatieverbinding ontkoppelen. Zakelijke gegevens kunnen daarna ontoegankelijk zijn.",
